      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              <h5 class="widget-title"><strong>SSAFY MALL</strong></h5>
              <ul class="menu-list list-unstyled">
                <li class="menu-item">
                  <a href="https://github.com/JOON-KR/ssafyMall" class="nav-link">About us</a>
                </li>
                <li class="menu-item">
                  <a href="https://github.com/JOON-KR/ssafyMall" class="nav-link">SSAFY MALL 소개</a>
                </li>
                <li class="menu-item">
                  <a href="https://github.com/JOON-KR/ssafyMall" class="nav-link">GitHub</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              <h5 class="widget-title"><strong>고객센터</strong></h5>
              <ul class="menu-list list-unstyled">
                <li class="menu-item">
          ...
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              <h5 class="widget-title"><strong>MY ACCOUNT</strong></h5>
              <ul class="menu-list list-unstyled">
                <li class="menu-item">
                  <a href="#" class="nav-link">회원정보수정</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">주문배송</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">취소/교환/반품 내역</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">상품리뷰 내역</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">증빙서류 발급</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer-menu">
              <h5 class="widget-title"><strong>Visit Our GitHub</strong></h5>
              <a href="https://github.com/JOON-KR/ssafyMall"><img src="@/assets/images/github.png" style="width: 50px"></a>
              <p>SSAFY MALL의 GitHub를 방문해보세요!💗</p>
            </div>
          </div>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6 copyright">
            <p>© 2024 SSAFY MALL. All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
